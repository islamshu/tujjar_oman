...
class AddonController extends Controller
{
    ...
    {
        $this->middleware('permission:addon maneger', ['only' => ['index','store']]);
        $this->middleware('permission:addon maneger', ['only' => ['activation']]);
        $this->middleware('permission:addon maneger', ['only' => ['create','store']]);
        $this->middleware('permission:addon maneger', ['only' => ['edit','update']]);
        $this->middleware('permission:addon maneger', ['only' => ['destroy']]);
        }
    /**

...
class ShopController extends BaseController
{
    ...
    public function allProducts($id)
    {
        ...
        $shops = new ProductCollection(Product::where('published', 1)->where('user_id', $shop->user_id)->latest()->get());
    ...
    {
        $shop = Shop::findOrFail($id);
        $shops = new ProductCollection(Product::where('published', 1)->where('user_id', $shop->user_id)->orderBy('num_of_sale', 'desc')->limit(4)->get());
    ...
    {
        $shop = Shop::findOrFail($id);
        $shops = new ProductCollection(Product::where('published', 1)->where(['user_id' => $shop->user_id, 'featured' => 1])->latest()->get());
    ...
    {
        $shop = Shop::findOrFail($id);
        $shops = new ProductCollection(Product::where('published', 1)->where('user_id', $shop->user_id)->orderBy('created_at', 'desc')->limit(10)->get());

...
class AuthController extends BaseController
{
    ...
    public function login(Request $request)
    {
        ...
        return $this->sendError('error validation','Confirm your phone number,or enter your phone number again' );
        $user = $request->user();
        $is_verfy = BusinessSetting::where('type','email_verification')->first()->value;
        if($is_verfy != 0){
            return $this->sendError('error validation','Please verify your account');
    ...
    public function logout(Request $request)
    {
        ...
        // ]);
        return $this->sendError('error validation','Successfully logged out');

...
class BusinessSettingsController extends Controller
{
    ...
    public function update_shipping(Request $request){
           $s = BusinessSetting::where('type', 'shipping_cost')->first();
    $s->value = $request->shipping_cost;
    $s->save();
    $b = BusinessSetting::where('type', 'tax')->first();
    $b->value = $request->tax;
    $b->save();
       $bb = BusinessSetting::where('type', 'tax_type')->first();
    $bb->value = $request->tax_type;
    $bb->save();
    foreach(Product::get() as $pro){
        $pro->tax = $b->value;
        $pro->tax_type = $bb->value;
        $pro->save();
    }
          flash(translate("Settings updated successfully"))->success();
        return back();

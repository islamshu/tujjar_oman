...
class CustomerController extends Controller
{
        ...
        $this->middleware('permission:customers', ['only' => ['index','store']]);
        $this->middleware('permission:customers', ['only' => ['create','store']]);
        $this->middleware('permission:customers', ['only' => ['edit','update']]);
        $this->middleware('permission:customers', ['only' => ['destroy']]);
        }
    /**

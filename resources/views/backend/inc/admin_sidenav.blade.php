                ...
                @if (  auth()->user()->hasPermissionTo('products')  )                
                    ...
                    <li class="aiz-side-nav-item">
                                <a href="{{route('business_settings.shipping_cost')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('shipping cost and tax')}}</span>
                                </a>
                            </li>
                @endif
                <!-- Sale -->
                ...
                @if (  auth()->user()->hasPermissionTo('markiting')  )                
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('notification.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['notification.index'])}}">

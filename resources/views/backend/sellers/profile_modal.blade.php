<div class="modal-body">
  ...
  <div class="text-center">
      ...
      <p class="text-sm text-muted">{{ $seller->user->shop->name }}</p>
        ...
        <p>{{translate('Phone')}} :    <a target="_blank" href="https://api.whatsapp.com/send?phone={{ $seller->user->phone }}">{{ $seller->user->phone }}</a>          </p>
         <p>{{translate('Type')}} :             {{App\Vendorpackege::find($seller->vendor_pakege_id)->title}}</p>

  ...
  <div class="card-body row">
      <div class="col-md-5">
          ...
          <p class="text-muted">
           ...
           <p class="text-muted">
              <strong>{{translate('Package Type')}}</strong>
              <span class="ml-2"> <strong> {{App\Vendorpackege::find($seller->vendor_pakege_id)->title}}  </strong> </span>
          </p>
          <p class="text-muted">
              <strong>{{translate('Payment Status')}}</strong>
              <span class="ml-2">@if($seller->paid == 1 ) <strong>  {{translate('Paid')}} </strong> @else  <strong>  {{translate('Unpaid')}} </strong> @endif</span>
          </p>

    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Tawani Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        <input type="hidden" name="payment_method" value="thawani">
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="thawani_Publishable_key">
                            <div class="col-lg-4">
                                <label class="col-from-label">{{translate('Thawani Publishable key')}}</label>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="thawani_Publishable_key" value="{{   env('thawani_Publishable_key') }}" placeholder="{{ translate('Thawani Api Key') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="thawani_Secret_key">
                            <div class="col-lg-4">
                                <label class="col-from-label">{{translate('Thawani Secret key')}}</label>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="thawani_Secret_key" value="{{  env('thawani_Secret_key') }}" placeholder="{{ translate('Thawani Secret Key') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Thawani test mode')}}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="thawani_sandbox" type="checkbox" @if (\App\BusinessSetting::where('type', 'thawani_sandbox')->first()->value == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>

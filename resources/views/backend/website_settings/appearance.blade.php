...
@section('content')
    ...
    <div class="row">
    	<div class="col-lg-8 mx-auto">
    				...
    				<form action="{{ route('business_settings.update') }}" method="POST">
    	                ...
    	                <div class="form-group row">
                            ...
                            <div class="col-md-8">
        	                    ...
        	                    <input type="color" style="width: 100px" name="base_color" class="form-control" placeholder="#377dff" value="{{ get_setting('base_color') }}">
    	                ...
    	                <div class="form-group row">
                            ...
                            <div class="col-md-8">
        	                    ...
        	                    <input type="color" style="width: 100px" name="base_hov_color" class="form-control" placeholder="#377dff" value="{{  get_setting('base_hov_color') }}">
        						<small class="text-muted">{{ translate('Hex Color Code') }}</small>
                            </div>
    	                </div>
			...
			<div class="card">
    			<div class="card-header">
    				<h6 class="fw-600 mb-0">{{ translate('Erorr Image') }}</h6>
    			</div>
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					@csrf
						<div class="form-group row">
    						<label class="col-md-3 col-from-label">{{ translate('Slider Error Image') }}</label>
                            <div class="col-md-8">
        						<div class="input-group " data-toggle="aizuploader" data-type="image">
        							<div class="input-group-prepend">
        								<div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
        							...
        							<div class="form-control file-amount">{{ translate('Choose File') }}</div>
        							<input type="hidden" name="types[]" value="error_slider">
        							<input type="hidden" name="error_slider" value="{{ get_setting('error_slider') }}" class="selected-files">
        						</div>
        						<div class="file-preview box"></div>
                            </div>
    					</div>
						<div class="form-group row">
    						<label class="col-md-3 col-from-label">{{ translate('Panner Error Image') }}</label>
                            <div class="col-md-8">
        						<div class="input-group " data-toggle="aizuploader" data-type="image">
        							<div class="input-group-prepend">
        								<div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
        							...
        							<div class="form-control file-amount">{{ translate('Choose File') }}</div>
        							<input type="hidden" name="types[]" value="error_panner">
        							<input type="hidden" name="error_panner" value="{{ get_setting('error_panner') }}" class="selected-files">
        						</div>
        						<div class="file-preview box"></div>
                            </div>
    					</div>
						<div class="form-group row">
    						<label class="col-md-3 col-from-label">{{ translate('Product Error Image') }}</label>
                            <div class="col-md-8">
        						<div class="input-group " data-toggle="aizuploader" data-type="image">
        							<div class="input-group-prepend">
        								<div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
        							...
        							<div class="form-control file-amount">{{ translate('Choose File') }}</div>
        							<input type="hidden" name="types[]" value="error_product">
        							<input type="hidden" name="error_product" value="{{ get_setting('error_product') }}" class="selected-files">
        						</div>
        						<div class="file-preview box"></div>
                            </div>
    					</div>
                            ...
                            <div class="col-md-8">
        						<div class="input-group " data-toggle="aizuploader" data-type="image">
        							...
        							<div class="form-control file-amount">{{ translate('Choose File') }}</div>
        							<input type="hidden" name="types[]" value="error_vendor">
        							<input type="hidden" name="error_vendor" value="{{ get_setting('error_vendor') }}" class="selected-files">
        						</div>
        						<div class="file-preview box"></div>
                            </div>
    					</div>

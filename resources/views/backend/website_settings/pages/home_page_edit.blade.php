	...
	<div class="card-body">
		<div class="row gutters-10">
			...
			<div class="col-lg-6">
				<div class="card shadow-none bg-light">
					<div class="card-header">
						<h6 class="mb-0">{{ translate('Home Banner show when not found flash deal ') }}</h6>
					</div>
					<div class="card-body">
						<form action="{{ route('business_settings.update_flash') }}" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="form-group">
								<label>{{ translate('Banner & Links') }}</label>
								<div class="home-banner1-target">
									@php
										$baner = App\GeneralSetting::first()->baneer_flash;
											...
											<div class="row gutters-5">
												<div class="col-5">
						                            ...
						                            <div class="file-preview box sm">
														{{-- <div class="input-group" data-toggle="aizuploader" data-type="image"> --}}
															<div >
																<input type="file" name="baneer_flash" class="form-control image">
															</div>
															{{-- <div class="form-control file-amount" >{{ translate('Choose File') }}</div>
															<input type="hidden" name="baneer_flash" class="selected-files image" value="{{ json_decode(get_setting('baneer_flash'), true) }}">
															 --}}
									
															<div class="form-group">
																<img src="{{ asset('public/'.@$baner) }}"  style="width: 100px" class="img-thumbnail image-preview" alt="">
															</div>

    ...
    <div class="aiz-user-sidenav rounded overflow-hidden  c-scrollbar-light">
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                $user_id = Auth::id();
                @endphp
                @if(App\Seller::where('user_id',$user_id)->first())
                  <li class="aiz-side-nav-item">
                     ...
                     <li class="aiz-side-nav-item">
                    <a href="{{ route('cards2.get') }}" class="aiz-side-nav-link ">
                        <i class="las la-atom aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Business card')}}</span>
                    </a>
                </li>
                @endif
                 ...
                 <li class="aiz-side-nav-item">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('reviews.seller') }}" class="aiz-side-nav-link {{ areActiveRoutes(['reviews.seller'])}}">
                            <i class="las la-check  aiz-side-nav-icon"></i>

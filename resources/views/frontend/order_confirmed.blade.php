                                ...
                                <div>
                                    <table class="table table-responsive-md">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">{{ translate('Attribute')}}</th>
                                        ...
                                        @foreach ($order->orderDetails as $key => $orderDetail)
                                            <tr>
                                                ...
                                                @if ($orderDetail->variation != null)
                                                    <td   class="text-center">@if($orderDetail->atts()['color'] != null) {{ translate('Color') }} : {{ $orderDetail->atts()['color'] }} @endif <br>
                                                        @if(@$orderDetail->atts()['size'] != null) {{ translate('size') }} : {{ @$orderDetail->atts()['size'] }} @endif <br>
                                                        @if(@$orderDetail->atts()['fabric'] != null) {{ translate('fabric') }} : {{ @$orderDetail->atts()['fabric'] }} @endif <br>
                                    ...
                                    <div class="col-xl-5 col-md-6 ml-auto mr-0">
                                        <table class="table ">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                        <span class="font-italic">        					{{ single_price($order->orderDetails->sum('shipping_cost')) }}
</span>
                                                </td>
                                            </tr>
                                            <tr>

            ...
            <div class="text-left">
                ...
                @if (\App\Addon::where('unique_identifier', 'club_point')->first() != null && \App\Addon::where('unique_identifier', 'club_point')->first()->activated && $product->earn_point > 0)
                    <div class="row no-gutters mt-4">
                        ...
                        <div class="col-10">
                            <div class="d-inline-block club-point bg-soft-base-1 border-primary-base-1 border">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-10">
                                    <div class="aiz-radio-inline">
                                        ...
                                        @php
                                        @$colorr = \App\Color::where('code', $color)->first()->name;
                                        @$qq = App\ProductStock::where('product_id',$product->id)->where('variant',$colorr)->first()->qty;

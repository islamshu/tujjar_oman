                                    ...
                                    <div class="row gutters-10">
                                        ...
                                        @if(\App\BusinessSetting::where('type', 'cash_payment')->first()->value == 1)
                                            ...
                                            @if($digital != 1)
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="thwani" class="online_payment" type="radio" name="payment_option" checked >
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            <img src="{{ static_asset('assets/img/cards/thwani.png')}}" style="height: 75px" class="img-fluid mb-2">
                                                            <span class="d-block text-center">
                                                                <span class="d-block fw-600 fs-15">{{ translate('thwani')}}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>

                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row gutters-5 row-cols-xxl-5 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                            @foreach ($products as $key => $product)
                                <div class="col mb-3">
                                    <div class="aiz-card-box h-100  border border-primary rounded shadow-sm hov-shadow-md has-transition bg-white" style="box-shadow: 3px 5px 7px #6b6167 !important;">
            ...
            echo App\BusinessSetting::where('type','base_color')->first()->value;
                    @endphp;
                        ">                                            <a href="{{ route('product', $product->slug) }}" class="d-block">
                                                <img
                                                    class="img-fit lazyload h-240px h-md-210px"

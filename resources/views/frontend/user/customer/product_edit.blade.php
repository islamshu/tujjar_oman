                ...
                <div class="aiz-user-panel">
                    ...
                    <ul class="nav nav-tabs nav-fill border-primary">
          				@foreach (\App\Language::all() as $key => $language)
          					<li class="nav-item">
          						<a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-primary border-left-0 @endif py-3" href="{{ route('customer_products.edit', ['id'=>$product->id, 'lang'=> $language->code] ) }}">

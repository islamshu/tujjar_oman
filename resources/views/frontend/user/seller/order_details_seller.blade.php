                ...
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>{{ json_decode($order->shipping_address)->address }}, {{ App\City2::find(json_decode($order->shipping_address)->city)->name() }}, {{App\City2::find(json_decode($order->shipping_address)->postal_code)->name()}}, {{ json_decode($order->shipping_address)->country }}</td>
                        </tr>
                        <tr>

                                    ...
                                    <div class="col-lg-6">
                                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                            ...
                                            <div>
                                                ...
                                                <span class="ml-2">{{ App\City2::find($address->postal_code)->name() }}</span>
                                            </div>
                                            <div>
                                                <span class="w-50 fw-600">{{ translate('City') }}:</span>
                                                <span class="ml-2">{{App\City2::find($address->city)->name() }}</span>
                                            </div>
                                            <div>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
 <select class="form-control aiz-selectpicker" data-live-search="true"  id="category" name="city">
                        ...
                        <div class="row">
                            ...
                            <select name="postal_code" id="subcategory" required class="form-control input-sm">
                                         @foreach(\App\City2::where('parent_id','=',1)->get() as $sub);
                                       <option value="{{$sub->id}}" disable >{{$sub->name()}} </option>
                                    @endforeach
                                            </select>          
                                            </div>
                        </div>

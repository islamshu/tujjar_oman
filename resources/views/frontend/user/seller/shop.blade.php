                        ...
                        <div class="card-body">
                            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-10">
                                         <select class="form-control aiz-selectpicker" id="category" data-live-search="true" name="address">
                                                ...
                                                @foreach (\App\City2::where('parent_id','=','0')->get() as $key => $city)
                                                 <option value="{{ $city->id }}" @if($city->id == $shop->address) selected  @endif>{{ $city->name() }}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="meta_description" rows="3" class="form-control mb-3" >{{  $shop->getTranslation('meta_description',$lang) }}</textarea>
                                    </div>
                                </div>

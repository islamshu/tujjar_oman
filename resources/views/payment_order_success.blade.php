                        ...
                        <table class="">
                            ...
                            @foreach ($order->orderDetails as $key => $orderDetail)
                                @if ($orderDetail->product != null)
                                    <tr class="">
                                        <td width="10%"class="">{{ single_price($orderDetail->price+$orderDetail->tax) }}</td>
                                        <td width="5%" class="">{{ single_price($orderDetail->tax/$orderDetail->quantity) }}</td>
                                        <td  width="10%" class="">{{ single_price($orderDetail->price/$orderDetail->quantity) }}</td>
                                        ...
                                        @if ($orderDetail->variation != null)
                                            <td  width="15%">@if($orderDetail->atts()['color'] != null) اللون : {{ $orderDetail->atts()['color'] }} @endif <br>
                    ...
                    <div class="table-total">
                        <table class="">
                            ...
                            <tr>
                                ...
                                <td class="value">{{ $shop->name_ar  }}</td>
                            </tr>
                            <tr>

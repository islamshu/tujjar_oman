...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    //Notifications
    Route::resource('notification','NotificationController')->only(['index','store']);
	...
	Route::post('/shipping_cost_update','BusinessSettingsController@update_shipping')->name('update_shipping');
